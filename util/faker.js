module.exports = function () {
  ...
  self.event = function (settings) {
    settings = settings || {};
    return {
      title: faker.Company.bs(),
      description: faker.Lorem.paragraph(),
      address: faker.Address.streetAddress(),
      latitude: settings.lat || faker.Helpers.randomNumber(-90.0, 90.0),
      longitude: settings.lng || faker.Helpers.randomNumber(-180.0, 180.0),
      ...
      organizerId: settings.organizerId || 'user' + faker.Helpers.randomNumber(100),
      featured: false,
